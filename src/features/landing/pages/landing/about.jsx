...
const featuresList = [
  {
    ...
    description: "Connect through real-time messaging, organized channels,threaded conversations, and collaborative discussions that keep teams aligned and projects moving forward.",
  ...
  },
  {
    ...
    description: "Host zero-lag, crystal-clear meetings with real-time interactive screen sharing, and automatic transcripts.",
    icon: Video,
